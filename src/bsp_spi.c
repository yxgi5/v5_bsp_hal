...
//ALIGN_32BYTES(uint8_t g_spiRxBuf[SPI_BUFFER_SIZE]);
...
* 功能说明: 配置SPI总线参数，波特率、
* 形    参: _BaudRatePrescaler:SPI_BAUDRATEPRESCALER_256之类
*           _CLKPhase:SPI_PHASE_1EDGE之类
*           _CLKPolarity:SPI_POLARITY_HIGH之类
* 返 回 值: 无
*********************************************************************************************************
*/
